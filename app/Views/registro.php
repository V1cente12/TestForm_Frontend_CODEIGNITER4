    ...
    <div class="row">
        <div class="col-xxl-8 col-lg-8 col-md-8 col-sm-12 ">               
            <div class="shadow-lg p-3 mb-5 mt-4 bg-body rounded">                                    
                <center>
                    <div class="p-3 mb-2 bg-success text-white">FORMULARIO</div>
                </center>
                <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-xxl-8 col-lg-8 col-md-8 col-sm-12">
                        ...
                        <input type="text" class="form-control" id="celular" name="tel" value="" maxlength="9" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" required>
                        <div class="valid-feedback"></div>
                        <div class="invalid-feedback">Complete los datos</div>
                    </div>                                          
